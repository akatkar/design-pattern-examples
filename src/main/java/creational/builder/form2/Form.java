...
public class Form {
    ...
    public static FormBuilder formBuilder(String firstName, String lastName, String userName, String password){
        return new FormBuilder(firstName, lastName, userName, password);
    }
